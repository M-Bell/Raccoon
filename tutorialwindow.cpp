...
//    this->setStyleSheet("background-color:#DDDDDD;");
    ...
    QPushButton *tutorialBarRulesBtn = new QPushButton(tutorialBarRulesIcon,"",this);
    ...
    tutorialBarRulesBtn->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
//    connect(tutorialBarRulesBtn, SIGNAL(clicked()), this, SLOT(on_tutorialBarRulesBtn_clicked()));
    ...
    QPushButton *tutorialBarOpeningsBtn = new QPushButton(tutorialBarOpeningsIcon,"",this);
    tutorialBarOpeningsBtn->setObjectName("tutorialBarOpeningsBtn");
    tutorialBarOpeningsBtn->resize(BAR_W, BAR_H);
    tutorialBarOpeningsBtn->move((parent->WINDOW_W-BAR_W)/2, 20*2+BAR_H*1);
    tutorialBarOpeningsBtn->setIconSize(QSize(BAR_W, BAR_H));
    tutorialBarOpeningsBtn->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
//    connect(tutorialBarOpeningsBtn, SIGNAL(clicked()), this, SLOT(on_tutorialBarOpeningsBtn_clicked()));
    ...
    QPushButton *tutorialBarEndgamesBtn = new QPushButton(tutorialBarEndgamesIcon,"",this);
    tutorialBarEndgamesBtn->setObjectName("tutorialBarEndgamesBtn");
    tutorialBarEndgamesBtn->resize(BAR_W, BAR_H);
    tutorialBarEndgamesBtn->move((parent->WINDOW_W-BAR_W)/2, 20*3+BAR_H*2);
    tutorialBarEndgamesBtn->setIconSize(QSize(BAR_W, BAR_H));
    tutorialBarEndgamesBtn->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
//    connect(tutorialBarEndgamesBtn, SIGNAL(clicked()), this, SLOT(on_tutorialBarEndgamesBtn_clicked()));
    ...
    QPushButton *tutorialBarPracticeBtn = new QPushButton(tutorialBarPracticeIcon,"",this);
    tutorialBarPracticeBtn->setObjectName("tutorialBarPracticeBtn");
    tutorialBarPracticeBtn->resize(BAR_W, BAR_H);
    tutorialBarPracticeBtn->move((parent->WINDOW_W-BAR_W)/2, 20*4+BAR_H*3);
    tutorialBarPracticeBtn->setIconSize(QSize(BAR_W, BAR_H));
    tutorialBarPracticeBtn->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
//    connect(tutorialBarPracticeBtn, SIGNAL(clicked()), this, SLOT(on_tutorialBarPracticeBtn_clicked()));
    ...
    QPushButton *tutorialBarAnalysisBtn = new QPushButton(tutorialBarAnalysisIcon,"",this);
    tutorialBarAnalysisBtn->setObjectName("tutorialBarAnalysisBtn");
    tutorialBarAnalysisBtn->resize(BAR_W, BAR_H);
    tutorialBarAnalysisBtn->move((parent->WINDOW_W-BAR_W)/2, 20*5+BAR_H*4);
    tutorialBarAnalysisBtn->setIconSize(QSize(BAR_W, BAR_H));
    tutorialBarAnalysisBtn->setStyleSheet("background-color: rgba(255, 255, 255, 0);");
//    connect(tutorialBarAnalysisBtn, SIGNAL(clicked()), this, SLOT(on_tutorialBarAnalysisBtn_clicked()));
